...
class DialogInputValueBox:BaseDialogFragment(){
    ...
    fun setTouchOutside(isTouchOutside:Boolean):DialogInputValueBox{
        this.isTouchOutside = isTouchOutside
        return this
    }

    fun setTitle(title:String?):DialogInputValueBox{
        if (title != null) {
            this.title = title
        }
        return this
    }
    fun setInputHint(hint:String):DialogInputValueBox{
        this.inputHint = hint
        return this
    }
    ...
    fun setActionType(actionType:Byte):DialogInputValueBox{
        this.actionType = actionType
        return this
    }
    fun setBackResult(consumer: Consumer<BoxActionResult>):DialogInputValueBox{
