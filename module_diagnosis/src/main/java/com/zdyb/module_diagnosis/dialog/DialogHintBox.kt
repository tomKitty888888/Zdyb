...
class DialogHintBox:BaseDialogFragment(){

    private var _binding: DialogHintBoxBinding? = null
    ...
    override fun onCreateView(
        ...
        _binding = DialogHintBoxBinding.inflate(layoutInflater, container, false)
        return binding.root
    }
    ...
    fun setTouchOutside(isTouchOutside:Boolean):DialogHintBox{
    ...
    fun setActionType(actionType:Byte):DialogHintBox{
        this.actionType = actionType
        return this
    }
    fun setBackResult(consumer: Consumer<Boolean>):DialogHintBox{
